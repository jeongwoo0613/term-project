...
router.route("/posts").get(post_controller_1.getPosts);
router.route("/posts/:postId").get(post_controller_1.getPost);
router.route("/:coinId/post").post(auth_controller_1.verifyToken, post_controller_1.createPost);
router.route("/:coinId/posts").get(post_controller_1.getCoinPosts);
router
    .route("/:coinId/posts/:postId")
    .get(post_controller_1.getCoinPost)
