...
__decorate([
    typeorm_1.OneToMany((type) => post_entity_1.Post, (post) => post.coin),
    __metadata("design:type", Array)
], Coin.prototype, "posts", void 0);
__decorate([
    typeorm_1.ManyToOne((type) => user_entity_1.User, (user) => user.interests),
    __metadata("design:type", user_entity_1.User)
], Coin.prototype, "user", void 0);
__decorate([
    typeorm_1.ManyToMany((type) => user_entity_1.User, (user) => user.rise),
    __metadata("design:type", Array)
], Coin.prototype, "rise", void 0);
__decorate([
    typeorm_1.ManyToMany((type) => user_entity_1.User, (user) => user.fall),
    __metadata("design:type", Array)
